(function () {
    describe("Account", function () {
        beforeEach(() => {
            account = new Account(121211);
        });

        describe("getNumber", function () {
            it("Returns accounts number", function () {
                assert.equal(account.getNumber(), 121211);
            });
        });
        ...
        describe("endOfMonth", function () {
            it("Prints out account details", function () {
    ...
    describe("CheckingAccount", function () {
        beforeEach(() => {
            checkingAccount = new CheckingAccount(500, 121211);
        });
        ...
        describe("withdraw", function () {
            describe("When the given amount is less than the balance", function () {
                it("Throws Error with Withdraw amount has to be greater than zero", function () {
        ...
        describe("endOfMonth", function () {
            describe("When the balance is less than 0", function () {
                it("Prints warning details of checking account", function () {
                    ...
                    assert.equal(checkingAccount.endOfMonth(), 'Warning, low balance CheckingAccount 121211: balance: -180 overdraft limit: 500');
                });
            });
